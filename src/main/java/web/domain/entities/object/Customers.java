...
public class Customers {
    ...
    public Customers(int customerNumber, String customerName, String contactLastName,
        ...
        this.checkValidation(customerNumber, customerName, contactLastName, contactFirstName, phone, addressLine1, city,
    ...
    private void checkValidation(final int customerNumber, final String customerName, final String contactLastName,
                                 final String contactFirstName, final String phone, final String addressLine1,
